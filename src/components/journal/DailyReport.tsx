    ...
    <Box>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body2" sx={{ color: "text.secondary" }}>
          Rapport quotidien · {entry.tasksTotal || 0} tâche
          {(entry.tasksTotal || 0) > 1 ? "s" : ""} prévues
        </Typography>
      </Box>
        ...
        <Card>
          <CardContent sx={{ py: 2.5 }}>
            ...
            <Box sx={{ display: "flex", alignItems: "flex-start", gap: 1 }}>
              <EditNoteRounded
                sx={{ color: "text.secondary", mt: 0.5, fontSize: "1.1rem" }}
              />
              <Typography
                variant="caption"
                sx={{ color: "text.secondary", fontWeight: 600, mt: 0.7 }}
              >
                Note du jour
              </Typography>
            </Box>
            <TextField
              ...
              placeholder={
                isToday
                  ? "Comment s'est passée ta journée ? Notes, réflexions..."
                  : "Aucune note"
              }
              value={note}
          ...
          >
            <Card sx={{ height: "100%" }}>
              <CardContent sx={{ p: 2, "&:last-child": { pb: 2 } }}>
                ...
                <Typography
                  sx={{ fontWeight: 800, fontSize: "1.1rem", mb: 0.8 }}
                >
                  {stat.value}
                </Typography>
                <LinearProgress
      ...
      <Card>
        <CardContent sx={{ pb: "16px !important" }}>
          ...
          >
            <Tab
              label={`✅ Tâches (${completedTasks.length})`}
              sx={{ fontWeight: 600, fontSize: "0.82rem" }}
            />
            <Tab
              label={`🔥 Habitudes (${habitsForDay.length})`}
              sx={{ fontWeight: 600, fontSize: "0.82rem" }}
            />
            <Tab
              label={`⏱ Pomodoro`}
                      ...
                      >
                        ...
                        <Box sx={{ flex: 1, minWidth: 0 }}>
                          ...
                          <Typography
                            variant="caption"
                            sx={{
                              color: task.wasLate ? "#F59E0B" : "#10B981",
                              fontWeight: 500,
                            }}
                          >
                            {task.wasLate
                          ...
                          {task.priority && (
                            <Box
                              sx={{
                                ...
                                borderRadius: "50%",
                                backgroundColor:
                                  PRIORITY_COLOR[task.priority] || "#06B6D4",
                              }}
                            />
                          )}
                        </Box>
          ...
          <TabPanel value={tab} index={2}>
            <Box sx={{ textAlign: "center", py: 3 }}>
              ...
              {(entry.pomodoroSessions || 0) === 0 && (
                ...
                >
                  Aucune session ce jour. Lance le Pomodoro pour booster ta
                  concentration !
                </Typography>
              )}
            </Box>
        ...
        <CardContent sx={{ p: 2.5 }}>
          ...
          {entry.aiInsights ? (
            ...
            <Box sx={{ textAlign: "center", py: 2 }}>
              ...
              >
                Génère un résumé personnalisé de ta journée avec des conseils
                d'amélioration.
              </Typography>
              <Box
                component="button"
