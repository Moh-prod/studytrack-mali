...
import { Box, Typography, IconButton, alpha, LinearProgress } from '@mui/material';
import {
      ...
      >
        <Box
          sx={{
            ...
            boxShadow: '0 12px 40px rgba(239,68,68,0.45), 0 2px 8px rgba(0,0,0,0.25)',
        ...
        >
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
            ...
            <Typography sx={{
              ...
              fontFamily: 'monospace', letterSpacing: '0.06em', minWidth: 56,
            }}>
              {formattedDuration}
            </Typography>
