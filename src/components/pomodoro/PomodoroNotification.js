...
import { CloseRounded, PlayArrowRounded, CoffeeRounded, VolumeOffRounded } from '@mui/icons-material';
 ...
 */
export default function PomodoroNotification({ notification, onDismiss, onAction }) {
  ...
  const colors = isWorkComplete
    ? {
        primary: '#7C3AED',
        secondary: '#06B6D4',
        gradient: 'linear-gradient(135deg, rgba(124,58,237,0.95), rgba(6,182,212,0.85))',
    ...
    : {
        primary: '#10B981',
        secondary: '#7C3AED',
        gradient: 'linear-gradient(135deg, rgba(16,185,129,0.95), rgba(124,58,237,0.85))',
