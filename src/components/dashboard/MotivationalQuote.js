        ...
        <CardContent sx={{ p: 3, position: 'relative' }}>
          <FormatQuoteRounded
            sx={{
              ...
              fontSize: 60, opacity: 0.08, color: 'primary.main',
            }}
          />
          <Typography variant="subtitle2" sx={{ color: 'primary.main', fontWeight: 600, mb: 2 }}>
            💡 Citation du jour
          </Typography>
          <Typography
            variant="body1"
          ...
          <Typography
            variant="body2"
            sx={{ textAlign: 'right', color: 'text.secondary', fontWeight: 600 }}
          >
            — {quote.author}
          </Typography>
        </CardContent>
