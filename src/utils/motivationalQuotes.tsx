const quotes = [
  ...
  {
    text: "N'attendez pas. Le moment ne sera jamais parfait.",
  ...
  {
    text: "Ton avenir est créé par ce que tu fais aujourd'hui, pas demain.",
    author: "Robert Kiyosaki",
  },
  {
    text: "La motivation vous met en route. L'habitude vous fait continuer.",
    author: "Jim Ryun",
  },
  {
    text: "Qui veut peut. Qui ne veut pas, cherche des excuses.",
    author: "Socrate",
  },
  {
  ...
  {
    text: "Ne juge pas chaque journée par la récolte que tu fais, mais par les graines que tu sèmes.",
    author: "Robert Louis Stevenson",
  },
  {
    text: "Les petits progrès quotidiens mènent à de grands résultats.",
  ...
  {
    text: "Le savoir est la seule richesse que l'on peut donner sans s'appauvrir.",
  ...
  {
    text: "Le progrès est impossible sans changement, et ceux qui ne peuvent pas changer leur esprit ne peuvent rien changer.",
    author: "George Bernard Shaw",
  },
  {
    text: "La seule personne que tu es destiné à devenir est la personne que tu décides d'être.",
    author: "Ralph Waldo Emerson",
  },
  {
    text: "Il est toujours trop tôt pour abandonner.",
  ...
  {
    text: "La clé du succès est de commencer avant d'être prêt.",
    author: "Marie Forleo",
  },
  {
    text: "Fais aujourd'hui ce que les autres ne veulent pas faire, et demain tu feras ce que les autres ne peuvent pas faire.",
    author: "Jerry Rice",
  },
  {
  ...
  {
    text: "La constance est la noblesse du résultat.",
  ...
  {
    text: "Investis en toi-même. Ta carrière est le moteur de ta richesse.",
    author: "Warren Buffett",
  },
  {
    text: "Les obstacles sont ces choses effrayantes que vous voyez quand vous quittez des yeux votre objectif.",
    author: "Henry Ford",
  },
  {
